<?php require "parts/header.php"; ?>
    ...
    <section>
        ...
        <h1 id="terms-heading-one">Terms and Conditions</h1>
        <p>Last updated: September 30, 2020
            Please read these terms and conditions carefully before using Our Service.</p>
        <h2 class="terms-heading-two">Interpretation and Definitions</h2>
        <h3 class="terms-heading-three">Interpretation</h3>
        <p>The words of which the initial letter is capitalized have meanings defined under the following conditions.
            The following definitions shall have the same meaning regardless of whether they appear in singular or in
            plural.</p>
        <h3 class="terms-heading-three">Definitions</h3>
        <p>For the purposes of these Terms and Conditions:
            ...
            <br> Country refers to: United Kingdom <br>
            <br> Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sherman
            & Co Financial Services, 73a Dollis Park, Finchley Central, London N3 1HJ. <br>
            <br> Device means any device that can access the Service such as a computer, a cellphone or a digital
            tablet. <br>
            <br> Feedback means feedback, innovations or suggestions sent by You regarding the attributes, performance
            or features of our Service.
            Service refers to the Website. <br>
            <br> Terms and Conditions (also referred as "Terms") mean these Terms and Conditions that form the entire
            agreement between You and the Company regarding the use of the Service. <br>
            <br> Third-party Social Media Service means any services or content (including data, information, products
            or services) provided by a third-party that may be displayed, included or made available by the Service.
            <br>
            <br> Website refers to Sherman & Co Financial Services, accessible from https://www.shermanfs.co.uk <br>
        ...
        <h2 class="terms-heading-two">Acknowledgment </h2>
        <p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between
            ...
            <br> Your access to and use of the Service is conditioned on Your acceptance of and compliance with these
            Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use
            the Service. <br>
            <br> By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree
            with any part of these Terms and Conditions then You may not access the Service. <br>
            <br> You represent that you are over the age of 18. The Company does not permit those under 18 to use the
            Service. <br>
            <br> Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the
        ...
        <h2 class="terms-heading-two">Intellectual Property</h2>
        <p>The Service and its original content (excluding Content provided by You or other users), features and
            functionality are and will remain the exclusive property of the Company and its licensors. <br>
            <br> The Service is protected by copyright, trademark, and other laws of both the Country and foreign
            countries. <br>
            <br> Our trademarks and trade dress may not be used in connection with any product or service without the
            prior written consent of the Company.
        </p>
        <h2 class="terms-heading-two">Your Feedback to Us</h2>
        ...
        <h2 class="terms-heading-two">Links to Other Websites </h2>
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by the
            Company. <br>
            <br> The Company has no control over, and assumes no responsibility for, the content, privacy policies, or
            ...
            such content, goods or services available on or through any such web sites or services. <br>
            <br>We strongly advise You to read the terms and conditions and privacy policies of any third-party web
            sites or services that You visit.
        </p>
        <h2 class="terms-heading-two">Termination here</h2>
        ...
        <h2 class="terms-heading-two">Limitation of Liability</h2>
        <p> Notwithstanding any damages that You might incur, the entire liability of the Company and any of its
            ...
            limited to the amount actually paid by You through the Service or 100 GBP if You haven't purchased anything
            through the Service. <br>
            <br> To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be
            ...
            <br> Some states do not allow the exclusion of implied warranties or limitation of liability for incidental
            or consequential damages, which means that some of the above limitations may not apply. In these states,
            each party's liability will be limited to the greatest extent permitted by law. <br>
        </p>
        <h2 class="terms-heading-two">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
        <p>The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of
            ...
            statutory or otherwise, with respect to the Service, including all implied warranties of merchantability,
            fitness for a particular purpose, title and non-infringement, and warranties that may arise out of course of
            dealing, course of performance, usage or trade practice. Without limitation to the foregoing, the Company
            ...
            can or will be corrected. <br>
            <br>Without limiting the foregoing, neither the Company nor any of the company's provider makes any
            ...
            scripts, trojan horses, worms, malware, timebombs or other harmful components. <br>
            ...
            extent enforceable under applicable law. <br>
            <br>
        </p>
        <h2 class="terms-heading-two">Governing Law</h2>
        ...
        <h2 class="terms-heading-two">Disputes Resolution</h2>
        ...
        <h2 class="terms-heading-two">For European Union (EU) Users</h2>
        ...
        <h2 class="terms-heading-two">United States Legal Compliance</h2>
        ...
        <h2 class="terms-heading-two">Severability and Waiver</h2>
        <h3 class="terms-heading-three">Severability </h3>
        ...
        <h3 class="terms-heading-two">Waiver </h3>
        ...
        <h2 class="terms-heading-two">Translation Interpretation</h2>
        ...
        <h2 class="terms-heading-two">Changes to These Terms and Conditions</h2>
        <p>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is
            ...
            <br> By continuing to access or use Our Service after those revisions become effective, You agree to be
            bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the
            website and the Service.
        </p>
        <h2 class="terms-heading-two">Contact Us</h2>
        <p>If you have any questions about these Terms and Conditions, You can contact us: <br>
            <br> By email: shermanfs.co.uk <br>
            By visiting this page on our website: https://www.shermanfs.co.uk <br>
            By phone number: +447541 353 678
        </p>
