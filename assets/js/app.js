...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#contactForm").submit(function (e) {
        e.preventDefault();
        var postData = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).serializeArray(),
            formURL = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).attr("action"),
            $cfResponse = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('#contactFormResponse'),
            $cfsubmit = __WEBPACK_IMPORTED_MODULE_0_jquery___default()("#contact-button"),
